...
export function RussiaMapSvg({ className = '', scale = 1 }: RussiaMapSvgProps) {
  // Более реалистичный контур России
  return (
    <svg
    ...
    >
      ...
      >
        ...
        {/* Декоративные точки для крупных городов */}
        <circle cx="400" cy="300" r="6" fill="#0da7bd" opacity="0.7" />
        <circle cx="800" cy="400" r="6" fill="#0da7bd" opacity="0.7" />
        <circle cx="1200" cy="350" r="6" fill="#0da7bd" opacity="0.7" />
        <circle cx="1600" cy="300" r="6" fill="#0da7bd" opacity="0.7" />
        <circle cx="1000" cy="600" r="6" fill="#0da7bd" opacity="0.7" />
        <circle cx="1900" cy="400" r="6" fill="#0da7bd" opacity="0.7" />
      </g>
    </svg>
  )
}
